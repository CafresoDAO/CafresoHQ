...
echo ""
echo "▶ create cafresoai_keys canister on mainnet (0.6 TC, paid from cycles ledger)"
...
dfx canister create cafresoai_keys --network ic --no-wallet --with-cycles 600000000000

echo ""
echo "▶ build cafresoai_keys"
...
echo ""
KEYS_ID=$(dfx canister id cafresoai_keys --network ic)
...
dfx generate cafresoai_keys

echo ""
echo "✓ mainnet deploy complete"
echo "  Canister id: $KEYS_ID"
echo "  Update frontend/.env.local with VITE_CAFRESOAI_KEYS_CANISTER_ID=$KEYS_ID"
