...
def run_js(cases_js):
    ...
    for fn in ('reasoningPatterns', 'stripReasoning', 'maskReasoning', 'extractAcks', 'stripAcks', 'stripOrphanTags', 'stripBlocks', 'stripSelfLabel', 'shownBody', 'visibleReply', 'extractAllDMs', 'extractApproval', 'isHandoffPlaceholder', 'vaultPaths', 'upToToolCall', 'placeholderRefusal', 'unsentHandoff', 'unsentElevation', 'unsentBlocks', 'unsentAsk', 'fabricatedRelay'):
