...
<div style="max-width: 760px; margin: 0 auto; padding: 36px 18px 80px;">
  ...
  ">
    <div style="display: flex; align-items: flex-start; gap: 16px; flex-wrap: wrap;">
      ...
      <div style="flex: 1; min-width: 0;">
        <h1 style="font-size: 22px; font-weight: 800; color: hsl(222 47% 11%); margin: 0 0 4px; letter-spacing: -0.02em;">
          {displayName}
        </h1>
        ...
        <div style="display: flex; gap: 16px; flex-wrap: wrap;">
          <span style="font-size: 12.5px; color: hsl(215 16% 47%); display: inline-flex; align-items: center; gap: 4px;">
            <Icon name="article" size={13} style="color: hsl(32 72% 50%);" /> {authoredPosts.length} post{authoredPosts.length !== 1 ? 's' : ''}
          </span>
          <span style="font-size: 12.5px; color: hsl(215 16% 47%); display: inline-flex; align-items: center; gap: 4px;">
            <Icon name="gavel" size={13} style="color: hsl(260 70% 62%);" /> {proposedBy.length} proposal{proposedBy.length !== 1 ? 's' : ''}
          </span>
        </div>
      </div>
      {#if isOwnProfile}
        <a href="/profile" style="
          ...
          background: hsl(222 47% 11%); color: white; text-decoration: none;
        ">
    ...
    ">
      ...
      <span style="font-size: 11.5px; color: hsl({hue} 35% 28%); line-height: 1.4;">
        ...
        <a href="https://app.sneeddao.com" target="_blank" rel="noopener" style="color: hsl(260 52% 44%); font-weight: 600;">Verify on SneedDAO →</a>
      </span>
    </div>
  </div>
  ...
  ">
    ...
    <span style="font-size: 12.5px; color: hsl(260 25% 72%); flex: 1; line-height: 1.5;">
    ...
    <span style="
      ...
      background: hsl(260 40% 28%); color: hsl(260 25% 68%); border-radius: 4px; padding: 2px 7px; flex-shrink: 0;
    ">Coming soon</span>
  </div>
</div>
