...
<div class="mt-7">
  <div class="flex items-baseline gap-3 mb-5">
    ...
    <span class="text-[13px]" style="color: hsl(215 16% 47%);">
  ...
  <div
    class="bg-white rounded-xl mb-7"
    style="border: 1px solid hsl(26 30% 85%); padding: 16px;"
  >
    <div class="flex gap-3 items-start">
      ...
      <div class="flex-1">
        <textarea
          ...
          style="min-height: 60px; font-family: inherit; color: hsl(222 47% 11%);"
        ></textarea>
        <div
          class="flex items-center flex-wrap pt-2.5"
          style="gap: 10px; border-top: 1px dashed hsl(26 25% 80%);"
        >
          <div class="inline-flex items-center gap-1.5 text-xs" style="color: hsl(215 16% 47%);">
      ...
      <div class="flex flex-col gap-4">
        <div class="flex gap-3">
          ...
          <div class="flex-1 min-w-0">
            <div class="flex items-center gap-2 flex-wrap mb-1">
              ...
              {#if c.author.isAuthor}
                <span
                  ...
                  style="font-size: 10px; letter-spacing: 0.06em; background: hsl(222 47% 11%); padding: 2px 7px; border-radius: 999px;"
                >Author</span>
              {/if}
              <span class="text-[11px]" style="color: hsl(215 16% 47%);">{c.author.role}</span>
              <span class="text-[11px]" style="color: hsl(215 16% 47%);">· {c.date}</span>
              {#if c.burned > 0}
                <span
            ...
            <div class="flex gap-3.5 mt-2 text-xs" style="color: hsl(215 16% 47%);">
              ...
              <div class="flex-1 min-w-0">
                <div class="flex items-center gap-2 flex-wrap mb-1">
                  ...
                  {#if r.author.isAuthor}
                    ...
                    >Author</span>
                  {/if}
                  <span class="text-[11px]" style="color: hsl(215 16% 47%);">{r.author.role}</span>
                  <span class="text-[11px]" style="color: hsl(215 16% 47%);">· {r.date}</span>
                </div>
