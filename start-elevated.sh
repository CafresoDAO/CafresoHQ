#!/usr/bin/env bash
# Launch serve.py with CafresoHQ elevated endpoint enabled.
...
export CAFRESOHQ_ALLOWED_DIRS="${CAFRESOHQ_ALLOWED_DIRS:-$HOME/Documents}"  # override per machine
export CAFRESOHQ_ALLOWED_TOOLS="Read,Write,Edit,Glob,Grep,Bash"
cd "$(dirname "$0")"
